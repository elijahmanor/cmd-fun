...
## Quickly cd to a previous directory
...
<Appear top={5}>
    <>
        <Highlight
            ...
            left={4}
            pwd="~/projects"
            command="npm init react-app some-really-long-app-name"
        />
        <Highlight top={2} left={4} pwd="~/projects" command="cd some-really-long-app-name" />
        <Highlight
            top={4}
            left={4}
            pwd="~/projects/some-really-long-app-name"
            command=""
        />
    </>
    <text top={6} left={0}>{`Instead of remembering the folder name or having to remember to cd afterwards...`}</text>
    <>
        <Highlight top={8} left={4} pwd="~/projects" command="npm init react-app some-really-long-app-name && cd $_" />
        <Highlight top={10} left={4} pwd="~/projects/some-really-long-app-name" />
    </>
    <text top={12} left={0}>{`NOTE: $_ represents the previous command's last argument or the previous command if there were no arguments.`}</text>
...
<text top={5} left={0}>With `zsh` path expansion, you don’t have to type whole directory paths anymore.</text>
...
<box top={6} left={40} width={30} height={4} border={{ type: 'none' }}>
    <text top={0} left={4}>• devpun -t react</text>
    <text top={1} left={4}>• cowsay -f vader</text>
    <text top={2} left={4}>• lolcatjs</text>
</box>
...
<box top={6} left={40} width={20} height={4} border={{ type: 'none' }}>
    <text top={0} left={4}>• cal -3</text>
    <text top={1} left={4}>• cal -y</text>
    <text top={2} left={4}>• cal 12 1976</text>
</box>
...
<Highlight top={5} left={4} command="npm install serve -g" />
<Highlight top={7} left={4} command="serve" />
<CopyButton top={9} left={4} textToCopy="serve" />
